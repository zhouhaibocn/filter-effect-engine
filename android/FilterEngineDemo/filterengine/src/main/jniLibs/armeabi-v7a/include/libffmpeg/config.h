...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --enable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=gif --enable-libx264 --enable-encoder=libx264 --enable-libmp3lame --enable-encoder=libmp3lame --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=png --enable-decoder=mjpeg --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=gif --enable-muxer=mp3 --enable-muxer=image2 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --enable-demuxer=gif --enable-demuxer=image2 --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --enable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --prefix=/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=android --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/ffmpeg-armv7a/3rdparty/build/libmp3lame/include/lame -I/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/ffmpeg-armv7a/3rdparty/build/libx264/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/ffmpeg-armv7a/3rdparty/build/libmp3lame/lib -lmp3lame -L/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/ffmpeg-armv7a/3rdparty/build/libx264/lib -lx264 -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/zhouhaibo/WorkSpace/MtimeEditorSDK/video-editor/extra/ijkplayer/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
...
#define CONFIG_CALLBACK_FILTER 1
