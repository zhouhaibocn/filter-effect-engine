...
#include "emerald_filter.h"

static ConstString Emerald_FSH = GLES_SHADER_STRING_PRECISION_H(
...
void EmeraldFilter::init(FilterConfig *filterConfig) {
    mFragmentShader = Emerald_FSH;
