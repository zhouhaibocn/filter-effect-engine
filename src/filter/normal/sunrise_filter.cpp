...
static ConstString Sunrise_FSH = GLES_SHADER_STRING_PRECISION_H(
        ...
        void main()
        {
            ...
            grey3Color = texture2D(inputImageTexture4, vec2(xCoordinate, yCoordinate));
            ...
            redCurveValue = texture2D(inputImageTexture1, vec2(base.r, 1.0)).a;
            greenCurveValue = texture2D(inputImageTexture1, vec2(base.g, 1.0)).a;
            blueCurveValue = texture2D(inputImageTexture1, vec2(base.b, 1.0)).a;
...
void SunriseFilter::init(FilterConfig *filterConfig) {
    mFragmentShader = Sunrise_FSH;
