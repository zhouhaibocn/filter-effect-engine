...
#include "blackcat_filter.h"

static ConstString Blackcat_FSH = GLES_SHADER_STRING_PRECISION_H(
        ...
        void main()
        {
            ...
            redCurveValue = texture2D(inputImageTexture1, vec2(tColor.r, 1.0)).r;
            greenCurveValue = texture2D(inputImageTexture1, vec2(tColor.g, 1.0)).r;
            blueCurveValue = texture2D(inputImageTexture1, vec2(tColor.b, 1.0)).r;
...
void BlackcatFilter::init(FilterConfig *filterConfig) {
    mFragmentShader = Blackcat_FSH;
