...
#include "latte_filter.h"

static ConstString Latte_FSH = GLES_SHADER_STRING_PRECISION_H(
...
void LatteFilter::init(FilterConfig *filterConfig) {
    mFragmentShader = Latte_FSH;
